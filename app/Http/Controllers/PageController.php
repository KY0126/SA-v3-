...
class PageController extends Controller
{
    ...
    public function module($name, Request $r) {
        ...
        $validModules = ['venue-booking','equipment','calendar','club-info','activity-wall','ai-overview','ai-guide','rag-search','rag-rental','repair','appeal','reports','e-portfolio','certificate','time-capsule','2fa','conflict-coordination','user-management'];
