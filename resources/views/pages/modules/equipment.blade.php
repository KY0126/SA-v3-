...
function renderEquipment(){
  ...
  if(s)data=data.filter(e=>e.name.toLowerCase().includes(s)||e.code.toLowerCase().includes(s)||(e.category||'').toLowerCase().includes(s));
  if(sort==='code-asc') data.sort((a,b)=>a.code.localeCompare(b.code));
